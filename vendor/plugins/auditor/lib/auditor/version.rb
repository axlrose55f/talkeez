class Version < ActiveRecord::Base
  ...
  # if they are also being versioned by Auditor.  NOTE: this isn't always guaranteed
  ...
  def reify_has_ones(model, lookback)
    model.class.reflect_on_all_associations(:has_one).each do |assoc|
      ...
      if child.respond_to? :version_at
        ...
        # but until Auditor knows which updates are "together" (e.g. parent and child being

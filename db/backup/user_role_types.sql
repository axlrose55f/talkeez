...
LOCK TABLES `user_role_types` WRITE;
/*!40000 ALTER TABLE `user_role_types` DISABLE KEYS */;
INSERT INTO `user_role_types` (`id`, `name`) VALUES 
(1,'Admin'),
(2,'User'),
(3,'Guest'),
(4,'Moderator'),
...
/*!40000 ALTER TABLE `user_role_types` ENABLE KEYS */;
UNLOCK TABLES;
